...
class GroceriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post groceries_url, params: { grocery: { name: @grocery.name, quantity: @grocery.quantity, user_id: @grocery.user_id } }
    end
  ...
  test "should update grocery" do
    patch grocery_url(@grocery), params: { grocery: { name: @grocery.name, quantity: @grocery.quantity, user_id: @grocery.user_id } }
